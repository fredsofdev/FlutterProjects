...
class UserData extends Equatable {
  ...
  factory UserData.fromToData(Map<String, dynamic> data) {
    final Map<String, dynamic> price = {
      'stage1': data['u_stage1Reward'] ?? 0,
      'stage2': data['u_stage2Reward'] ?? 0,
      'stage3': data['u_stage3Reward'] ?? 0,
      'stage4': data['u_stage4Reward'] ?? 0,
      'stage5': data['u_stage5Reward'] ?? 0,
      'stage6': data['u_stage6Reward'] ?? 0,
    };
    ...
    return UserData(
        ...
        uOnline: data['u_online'] as bool ?? false,
        uRankPoint: data['u_rankPoint'] as int ?? 0,
        uCoin: data['u_coin'] as int ?? 0,
        uLastSeen: data['u_lastSeen'].toString() ?? "",
        uPlayCoin: data['u_playCoin'] as int ?? 0,
        itemPlayTime: data['itemPlayTime'] as int ?? 0,
        itemPurpleCoin: data['itemPurpleCoin'] as int ?? 0,
        itemGoldCoin: data['itemGoldCoin'] as int ?? 0,
        itemRotationCount: data['itemRotateCount'] as int ?? 0,
        uTotalPlayCount: data['u_totalPlayCount'] as int ?? 1,
        uWins: data['u_wins'] as int ?? 0,
        uRewards: price,
        isNewMail: data['is_newMail'] as bool ?? false,
        uStage1Total: data['u_stage1Total'] as int ?? 1,
        uStage2Total: data['u_stage2Total'] as int ?? 1,
        uStage3Total: data['u_stage3Total'] as int ?? 1,
        uStage4Total: data['u_stage4Total'] as int ?? 1,
        uStage5Total: data['u_stage5Total'] as int ?? 1,
        uStage6Total: data['u_stage6Total'] as int ?? 1,
        uStage1Wins: data['u_stage1Wins'] as int ?? 0,
        uStage2Wins: data['u_stage2Wins'] as int ?? 0,
        uStage3Wins: data['u_stage3Wins'] as int ?? 0,
        uStage4Wins: data['u_stage4Wins'] as int ?? 0,
        uStage5Wins: data['u_stage5Wins'] as int ?? 0,
        uStage6Wins: data['u_stage6Wins'] as int ?? 0);
  }
