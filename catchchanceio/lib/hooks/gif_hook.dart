...
//
// GifController useGifController({required TickerProvider provider,required int duration}) {
...
//   final int duration;
//
//   const _GifController({required this.provider,required this.duration});
//
//   @override
